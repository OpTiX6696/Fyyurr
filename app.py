...
def index():
  ...
  recent_venues = Venue.query.with_entities(Venue.city, Venue.state).group_by(Venue.state, Venue.city, Venue.id).order_by(Venue.id.desc()).limit(10).all()
  ...
  return render_template('pages/home.html', shows=upcoming_shows_data, areas=recent_venue_data)
...
def edit_artist_submission(artist_id):
  ...
  try:
    ...
    # artist.looking_for_venues, artist.genres = request.form.get('seeking_venue'), ", ".join(request.form.getlist('genres'))
    # artist.looking_for_venues = request.form.get('seeking_venue')

    
    # artist.name, artist.city, artist.genres, artist.state, artist.phone, artist.image_link, artist.website_link, artist.facebook_link, artist.description, artist.looking_for_venues = request.form.get('name'), request.form.get('city'), ", ".join(request.form.getlist('genres')), request.form.get('state'), request.form.get('phone'), request.form.get('image_link'), request.form.get('website_link'), request.form.get('facebook_link'), request.form.get('seeking_description'), request.form.get('seeking_venue')
